...
func RegisterTools(s *server.MCPServer, screenshotQuality int) {
	s.AddTool(mcp.NewTool("puppeteer_navigate",
	...
	s.AddTool(mcp.NewTool("puppeteer_screenshot",
	...
	s.AddTool(mcp.NewTool("puppeteer_click",
	...
	s.AddTool(mcp.NewTool("puppeteer_fill",
	...
	s.AddTool(mcp.NewTool("puppeteer_select",
	...
	s.AddTool(mcp.NewTool("puppeteer_hover",
	...
	s.AddTool(mcp.NewTool("puppeteer_evaluate",
	...
	s.AddTool(mcp.NewTool("puppeteer_mouse_click",
	...
	s.AddTool(mcp.NewTool("puppeteer_mouse_move",
	...
	s.AddTool(mcp.NewTool("puppeteer_mouse_down",
	...
	s.AddTool(mcp.NewTool("puppeteer_mouse_up",
	...
	s.AddTool(mcp.NewTool("puppeteer_mouse_drag",
	...
	s.AddTool(mcp.NewTool("puppeteer_mouse_wheel",
	...
	s.AddTool(mcp.NewTool("puppeteer_get_cookies",
	...
	s.AddTool(mcp.NewTool("puppeteer_set_cookies",
	...
	s.AddTool(mcp.NewTool("puppeteer_delete_cookies",
